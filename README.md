...
- modal can be `us` or `xray`， change the datapath in samples.json to your local path if needed.
...
### Training Scripts
- prepare SFT datafiles and run `scripts/sft_lora_qwen.sh`
- prepare RL-format datafiles and run `scripts/rl_lora_qwen.sh`
